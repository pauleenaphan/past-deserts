export const recipesData = [
    ...
    },
    {
        ...
        "bodyArticle": 
            `Cheesecake has always been one of my favorite desserts because it's super sweet and kind of cheesey in a way. Originally I was going to make mini pumpkin pies but the mini crust was actually <a href="https://www.amazon.com/Keebler-Ready-Crusts-Graham-Cracker/dp/B09M9CX6FG"> graham cracker crust</a>. ` +
            "Cheesecake uses a graham cracker crust so I made mini blue berry cheese cakes instead. <br/> <br/>" +
    ...
    },
    {
        "id": 8,
        "name": "Cheese Danish",
        "description": "First puff pastry I ever made! Also first time making my own dough.",
        "bodyArticle":
            `<a href="https://sugarspunrun.com/how-to-make-puff-pastry-recipe/"> Puff Pastry Dough Recipe </a> <br/>` +
            "I was kind of hesitant of baking this because of the dough. I never made my own dough before and was scared of failure, but you never know if you don't try right? I'm glad I did because it turned out really good! To be honest when I was making the puff pastry dough it did look a bit unusual but I just had to smooth it out and keep rolling it. <br/><br/>" +
            "Look how smooth the dough looks in the picture below. The dough turned out amazing! I was super happy with it. One thing that was off was the mini oven. The danishes in the back cooked a little faster than the ones in the front. So some danishes looks more cooked than others. <br/><br/>" +
            "Another thing was using aluminum foil instead of parchment paper. The danishes did stick a little bit but it didn't stick as much. Though the bottom of the pastries were cooked but not super flaky as I would want it to be. I looked it up and it says foil isn't the best because it can distribute heat rather than hold it. So it could lead to uneven cooking. <br/><br/>" +
